...
import { createEnemy, finishLevel } from './main.js';
...
export default async function playLevel(currentFrame) {
  switch(currentFrame) {
    ...
    case 1296: createEnemy(70, 6, -250, launcher, 'A', true, -1); break;
    case 1296: createEnemy(-50, 70, -170, E1, 'A', false, -1); break;
    case 1344: createEnemy(-70, 6, -250, launcher, 'A', true, -1); break;
    case 1344: createEnemy(-120, 70, -170, E1, 'A', false, -1); break;
    ...
    case 2784: createEnemy(0, 70, -150, E2, 'D', false, -1); break;
    ...
    case 3318: createEnemy(-100, 6, -300, launcher, 'A', true, -1); break;
    case 3318: createEnemy(-360, 70, -120, E1, 'B', false, -1); break;
    case 3378: createEnemy(-360, 70, -120, E1, 'B', false, -1); break;
    case 3438: createEnemy(-360, 70, -120, E1, 'B', false, -1); break;
    case 3498: createEnemy(-360, 70, -120, E1, 'B', false, -1); break;
    ...
    case 4782: createEnemy(-150, 70, -170, E1, 'A', false, -1); break;
    case 4782: createEnemy(360, 70, -20, E1, 'B', false, 1); break;
    case 4830: createEnemy(-100, 70, -170, E1, 'A', false, -1); break;
    case 4830: createEnemy(360, 70, -70, E1, 'B', false, 1); break;
    case 4878: createEnemy(-50, 70, -170, E1, 'A', false, -1); break;
    case 4878: createEnemy(360, 70, -120, E1, 'B', false, 1); break;
    ...
    case 5514: createEnemy(10, 6, -250, launcher, 'A', true, -1); break;
    case 5964: createEnemy(0, 70, -170, E1, 'A', false, -1); break;
    case 5964: createEnemy(150, 6, -250, launcher, 'A', true, -1); break;
    case 5964: createEnemy(-150, 6, -250, launcher, 'A', true, -1); break;
    case 6024: createEnemy(-40, 70, -170, E1, 'A', false, -1); break;
    case 6024: createEnemy(40, 70, -170, E1, 'A', false, -1); break;
    case 6084: createEnemy(-80, 70, -170, E1, 'A', false, -1); break;
    case 6084: createEnemy(80, 70, -170, E1, 'A', false, -1); break;
    case 6144: createEnemy(-120, 70, -170, E1, 'A', false, -1); break;
    case 6144: createEnemy(120, 70, -170, E1, 'A', false, -1); break;
    case 6204: createEnemy(-160, 70, -170, E1, 'A', false, -1); break;
    case 6204: createEnemy(160, 70, -170, E1, 'A', false, -1); break;
    case 6204: createEnemy(0, 6, -250, launcher, 'A', true, -1); break;
    ...
    case 7086: createEnemy(-360, 70, 0, E1, 'B', false, -1); break;
    case 7086: createEnemy(360, 70, 30, E1, 'B', false, 1); break;
    case 7134: createEnemy(-360, 70, 0, E1, 'B', false, -1); break;
    case 7134: createEnemy(360, 70, 30, E1, 'B', false, 1); break;
    case 7152: createEnemy(-80, 70, -170, E1, 'A', false, -1); break;
    case 7152: createEnemy(0, 70, -170, E1, 'A', false, -1); break;
    case 7152: createEnemy(80, 70, -170, E1, 'A', false, -1); break;
    case 7152: createEnemy(100, 6, -250, launcher, 'A', true, -1); break;
    case 7152: createEnemy(-100, 6, -250, launcher, 'A', true, -1); break;
