...
let plane = createGroundPlaneWired(40, 30,40,30)
scene.add(plane);
let plane2 = createGroundPlaneWired(40, 30,40,30,"rgb(60,30,20")
plane2.translateY(30);
scene.add(plane2);
...
function render()
{
 ...
 if(plane2.position.z > 15)
 {
   plane2.position.set(0,0,-45);
 }
